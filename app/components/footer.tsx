...
function Social({ href, label, children, hoverClass }:{
  href: string; label: string; children: React.ReactNode; hoverClass: string;
}) {
  return (
    <a
      href={href}
      ...
      target="_blank"
      rel="noreferrer"
      className={`inline-flex h-10 w-10 items-center justify-center rounded-full ring-1 ring-gray-200 text-gray-500 transition-all hover:-translate-y-0.5 hover:shadow-md ${hoverClass}`}
    >
      {children}
    </a>
  );
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3 flex gap-3">
              <Social href="https://x.com/" label="Twitter"  hoverClass="hover:text-black hover:ring-gray-400/40">
              ...
              <Social href="https://instagram.com/" label="Instagram" hoverClass="hover:text-pink-600 hover:ring-pink-400/40">
              ...
              <Social href="https://linkedin.com/"  label="LinkedIn" hoverClass="hover:text-blue-600 hover:ring-blue-400/40">
              ...
              <Social href="mailto:hello@talentkonnect.example" label="Email" hoverClass="hover:text-emerald-600 hover:ring-emerald-400/40">
